...
The production durability protocol itself is unchanged from Pass111. Pass112 adds an offline, mechanically checked Lean artifact plus a hostile source-refinement binder to the existing Rust finite model and subprocess crash matrix.
